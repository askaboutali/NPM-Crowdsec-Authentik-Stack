...
> If you actually want this setup to be properly done, and wish to learn more, you should realistically be reading the ***official documentation*** for each of the services used, not my GitHub :)
